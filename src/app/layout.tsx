...
export const metadata: Metadata = {
  ...
  description: "Portfolio of Rosyad Zain — Product Designer crafting UI/UX, web, and AI-augmented 3D experiences.",
  ...
  openGraph: {
    ...
    description: "Product Designer crafting UI/UX, web, and AI-augmented 3D experiences.",
    type: "website",
...
const jsonLd = {
  ...
  description: "Product Designer crafting UI/UX, web, and AI-augmented 3D experiences.",
  knowsAbout: ["Product Design", "UI/UX Design", "Brand Identity", "Figma", "Unreal Engine 5", "3D Environment", "Modern Web", "AI-Augmented Workflows"],
